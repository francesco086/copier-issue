...
# For example you can check whether all packages are installed or whether the configurations are correctly set.
# If you leave this file as it is, or anyway empty, no test will be run.
